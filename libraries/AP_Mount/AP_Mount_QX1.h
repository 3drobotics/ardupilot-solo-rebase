...
#ifndef __AP_Mount_QX1_H__
#define __AP_Mount_QX1_H__
...
class AP_Mount_QX1 : public AP_Mount_Backend
{
public:
    // Constructor
    AP_Mount_QX1(AP_Mount &frontend, AP_Mount::mount_state &state, uint8_t instance):
