...
void AP_Mount_QX1::init(const AP_SerialManager& serial_manager)
{
    if (_instance == 0) {
...
void AP_Mount_QX1::set_mode(enum MAV_MOUNT_MODE mode)
{
...
void AP_Mount_QX1::check_servo_map()
{
...
void AP_Mount_QX1::status_msg(mavlink_channel_t chan)
{
...
int16_t AP_Mount_QX1::closest_limit(int16_t angle, int16_t angle_min, int16_t angle_max)
{
...
void AP_Mount_QX1::move_servo(uint8_t function_idx, int16_t angle, int16_t angle_min, int16_t angle_max)
{
