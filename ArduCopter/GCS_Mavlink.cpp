...
void GCS_MAVLINK::handleMessage(mavlink_message_t* msg)
{
    ...
    case MAVLINK_MSG_ID_SET_POSITION_TARGET_GLOBAL_INT:    // MAV ID: 86
    {
        ...
        if (packet.coordinate_frame != MAV_FRAME_GLOBAL_INT &&
            packet.coordinate_frame != MAV_FRAME_GLOBAL_RELATIVE_ALT && // HACK: shot manager sends RELATIVE_ALT instead of RELATIVE_ALT_INT
        ...
        if(!pos_ignore) {
            ...
            switch (packet.coordinate_frame) {
                case MAV_FRAME_GLOBAL_RELATIVE_ALT: // HACK: shot manager sends RELATIVE_ALT instead of RELATIVE_ALT_INT
